            ...
            <div class="flex flex-wrap gap40">
                <div>
                    ...
                    <div class="flex items-center gap10">
                        <h4>{{ Currency::format($totals['all']) }}</h4>
                    </div>
                </div>
                <div>
                    <div class="mb-2">
                    ...
                    <div class="flex items-center gap10">
                        <h4>{{ Currency::format($totals['ordered']) }}</h4>
                    </div>
                </div>
                <div>
                    <div class="mb-2">
                    ...
                    <div class="flex items-center gap10">
                        <h4>{{ Currency::format($totals['delivered']) }}</h4>
                    </div>
                </div>
                <div>
                    <div class="mb-2">
                    ...
                    <div class="flex items-center gap10">
                        <h4>{{ Currency::format($totals['canceled']) }}</h4>
                    </div>
                </div>
            </div>
