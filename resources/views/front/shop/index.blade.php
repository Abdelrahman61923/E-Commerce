                        ...
                        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                            ...
                            <div class="price-range__info d-flex align-items-center mt-2">
                                <div class="me-auto">
                                    ...
                                    <span
                                        class="price-range__min">{{ App\Helpers\Currency::format($min_price) }}</span>
                                </div>
                                <div>
                                    <span class="text-secondary">Max Price: </span>
                                    <span
                                        class="price-range__max">{{ App\Helpers\Currency::format($max_price) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="shop-list flex-grow-1">
                <div class="swiper-container js-swiper-slider slideshow slideshow_small slideshow_split"
                    data-settings='{"autoplay": {"delay": 5000}, "slidesPerView": 1, "effect": "fade", "loop": true,
                        "pagination": {"el": ".slideshow-pagination", "type": "bullets", "clickable": true}}'>
                                            ...
                                            @foreach ($product->all_images as $img)
                                                <div class="swiper-slide">
                                                    <a href="{{ route('shop.show', $product->slug) }}"><img
                                                            loading="lazy" src="{{ $img }}" width="330"
