                                    ...
                                    <tr>
                                        <td>
                                            <div class="shopping-cart__product-item">
                                                <img loading="lazy" src="{{ asset('storage/' . $item->model->image) }}"
                                        ...
                                        <td>
                                            <form action="{{ route('cart.item.remove', $item->rowId) }}" method="post">
                                                @csrf
                                                @method('delete')
                                                <a href="javascript:void()" class="remove-cart">
                        ...
                        <div class="sticky-content">
                                ...
                                @else
                                    <table class="cart-totals">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>VAT</th>
                                                <td>${{ Cart::instance('cart')->tax() }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Total</th>
                                                <td>${{ Cart::instance('cart')->total() }}
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="mobile_fixed-btn_wrapper">
                                <div class="button-wrapper container">
                                    <a href="{{ route('order.checkout') }}" class="btn btn-primary btn-checkout">PROCEED TO CHECKOUT</a>
                                </div>
                            </div>
                        </div>
                    </div>
                @else
                    <div class="row">
                        <div class="col-md-12 text-center pt-5 bp-5">
                            <p>No item fount in your cart</p>
