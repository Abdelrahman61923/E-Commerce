<x-front-layout>
    <main class="pt-90">
        ...
        <section class="shop-checkout container">
            ...
            <form name="checkout-form" action="{{ route('order.place') }}" method="post">
                @csrf
                                ...
                                @if (Session::has('discounts'))
                                    <table class="checkout-totals">
                                        <tbody>
                                            <tr>
                                                <th>Subtotal</th>
                                                <td class="text-right">${{ Cart::instance('cart')->subTotal() }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Discount {{ Session::get('coupon')['code'] }}</th>
                                                <td class="text-right">{{ Currency::format(Session::get('discounts')['discount']) }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Subtotal After Discount</th>
                                                <td class="text-right">{{ Currency::format(Session::get('discounts')['subtotal']) }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Shipping</th>
                                            ...
                                            <tr>
                                                <th>VAT</th>
                                                <td class="text-right">{{ Currency::format(Session::get('discounts')['tax']) }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Total</th>
                                                <td class="text-right">{{ Currency::format(Session::get('discounts')['total']) }}
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
