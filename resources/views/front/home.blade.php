        ...
        "loop": true
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="overflow-hidden position-relative h-100">
                        <div class="slideshow-character position-absolute bottom-0 pos_right-center">
                            <img loading="lazy" src="{{ asset('assets/images/slideshow-character2.png') }}"
        ...
        <div class="container mw-1620 bg-white border-radius-10">
                  ...
                  "pagination": false
                        ...
                        <div class="swiper-wrapper">
                            @foreach ($categories as $category)
                                <div class="swiper-slide">
                                    <img loading="lazy" class="w-100 h-auto mb-3" src="{{ $category->image_url }}"
                    ...
                    <div class="col-md-6">
                        <div class="category-banner__item border-radius-10 mb-5">
                            ...
                            <div class="category-banner__item-content">
                                ...
                                <a href="{{ route('shop.index') }}" class="btn-link default-underline text-uppercase fw-medium">Shop
                                    Now</a>
                            </div>
                        </div>
                    </div>
            ...
            <section class="products-grid container">
                    ...
                    @foreach ($featuredProducts as $product)
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                                <div class="pc__img-wrapper">
                                    <a href="{{ route('shop.show', $product->slug) }}">
                                        <img loading="lazy" src="{{ $product->image_url }}" width="330"
                ...
                <div class="text-center mt-2">
                    <a class="btn-link btn-link_lg default-underline text-uppercase fw-medium" href="javascript:void(0)">Load
                        More</a>
                </div>
            </section>
        </div>
